...
numeric_columns = ['humidity', 'temperature', 'duration']
categorical_columns = ['nutrients']
...
st.subheader('Mapa de Humidade de Correlação')
...
with col1:
    x_var = st.selectbox('Selecione a variável X:', options=numeric_columns, index=0)
with col2:
    y_var = st.selectbox('Selecione a variável Y:', options=numeric_columns, index=1)
with col3:
